         ...
         <div className="footer-grid">
           <div className="footer-column">
             ...
             <p
               ...
               style={{ fontStyle: 'italic', color: 'rgba(255, 255, 255, 0.9)', marginBottom: '12px' }}
             >
             ...
             <div className="footer-social">
               <a
                 href="https://www.facebook.com/uaebusinessdeskuae"
                 target="_blank"
               ...
               <a
                 href="https://www.linkedin.com/company/uaebusinessdesk/"
                 target="_blank"
                 rel="noopener noreferrer"
                 className="social-link"
                 aria-label="LinkedIn"
               ...
               <a
                 href="https://www.instagram.com/uaebusinessdesk/"
                 target="_blank"
                 rel="noopener noreferrer"
                 className="social-link"
