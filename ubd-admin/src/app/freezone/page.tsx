          ...
          <div className="mainland-section">
            <div className="mainland-intro-grid">
              ...
              <div className="mainland-intro-image">
                <Image src="/assets/freezone-intro.jpg" alt="UAE Free Zones" width={500} height={400} />
              </div>
            </div>
            ...
            <div className="why-mainland-wrapper">
              ...
              <div className="benefits-grid">
                <div className="benefits-image">
                  <Image src="/assets/freezone-benefits.jpg" alt="UAE Free Zone Benefits" width={500} height={400} />
                </div>
        ...
        <div className="content-wrapper">
          ...
          <div className="legal-structure-grid">
            ...
            <div className="legal-structure-image">
              <Image src="/assets/freezone-legal.jpg" alt="Legal Structure UAE Free Zone" width={500} height={400} />
            </div>
          </div>
        </div>
      </div>
