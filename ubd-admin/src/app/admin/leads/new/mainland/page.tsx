...
export default function NewMainlandLeadPage() {
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Create Mainland Company Lead</h1>
            </div>
            <p className="text-sm text-gray-500 ml-4">Add a new lead for mainland company setup</p>
          </div>
          ...
          <LeadForm
            ...
            serviceLabel="Mainland Company Setup"
          />
        </div>
      </div>
    </div>
